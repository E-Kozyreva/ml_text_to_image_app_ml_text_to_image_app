...
window.setStyleSheet("background-color: #E9EDC9;")   


top_label = QLabel(window)
top_label.setStyleSheet("""background-color: #F8F8F8;
                            border-radius: 10px;
                            padding: 5px;""")
...
top_next_label.setStyleSheet("""background-color: #D4A373;
                                color: #FFFFFF; 
                                font-size: 30px; 
...
center_lower_label.setStyleSheet("""background-color: #E9EDC9;
                                    border-radius: 30px;
                                    padding: 10px;
                                    """)
...
center_top_label.setStyleSheet("""background-color: #FEFAE0;
                                  border-radius: 40px;
                                  padding: 10px;
                                  """)
...
text_input.setStyleSheet("""background-color: #FEFAE0;
                            color: #CCD5AE;
                            border-radius: 15px;
                            padding: 10px;
                            font-size: 15px;
...
generate_button.setStyleSheet("""background-color: #F8F8F8;
                                 color: #D4A373;
                                 border-radius: 15px;
                                 padding: 10px;
                                 font-size: 15px;
...
lower_label.setStyleSheet("""background-color: #D4A373;
                             border-radius: 10px;
                             padding: 5px;""")
